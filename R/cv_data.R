...
manuscripts_data <- tribble(
  ...
  "In progress"                                                                                                                                                                  ,
  NA_character_                                                                                                                                                                  , NA_character_ , NA_character_ , NA_character_ ,
  "Santos NB, Miramonti AA, Fox G, Abresch C, Franzen-Castle L"                                                                                                                  ,
  "Latino Consumer Food Environments: A cross-sectional analysis of rural food retailers"                                                                                        ,
  "Under review"                                                                                                                                                                 ,
  "International Journal of Environmental Research and Public Health"                                                                                                            , "2026-06-15" , "2026-06-15" , "MS ID ijerph-4410083 (MDPI/IJERPH); resubmitted from Nutrition & Dietetics (was MS ID 4212250); co-author" ,
